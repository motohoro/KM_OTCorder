...
$("body").prepend('<div id="scanpane"><div><video id="preview" width="300" height="150" style="text-align:center;display:none"></video></div><div><button id="scanbtn">SCAN</button></div><div id="scannamelist"></div></div><button id="barcodevisiblebtn" style="display:none"  onclick="showqrcode();">バーコード表示</button>');
